...
//        auto& v2 = func_value(); // 1.2 - v2 type will not compile
...
//        auto& v2 = func_ccptr(); // 6.2 - v2 type will not compile
        const auto& v3 = func_ccptr(); // 6.3 - v3 type const int * const &
        auto&& v4 = func_ccptr(); // 6.4 - v4 type const int * const &&
        auto&& v5 = func_ccptr(); // 6.4 - v4 type const int * &&
    }
    {
        auto v1 = func_rref(); // 7.1 - v1 type int
//        auto& v2 = func_rref(); // 7.2 - v2 type will not compile
...
//        auto v6 = {1, 2, 3.0}; // 8.6 - v6 type will not compile
    }
    return 0;
}